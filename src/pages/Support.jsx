    ...
    <div className="dash-layout">
      ...
      <aside className={`dash-sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="dash-menu">
          ...
          <li className="active" onClick={() => navigate('/support')}>
      ...
      <main className="dash-main">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', minHeight: '60vh' }}>
          <h1 style={{color: '#111', marginBottom: '20px'}}>Digital Atelier Support Page</h1>
          <p style={{color: '#6a6a7c'}}>How can we help you with your boutique management?</p>
        </div>
      </main>
    </div>
  );
